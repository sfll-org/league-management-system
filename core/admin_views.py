...
def user_detail(request, pk):
    ...
    roles = UserRole.objects.filter(user=target_user).select_related('division', 'league')
...
def add_role(request, pk):
    ...
    messages.success(request, f'Added {dict(UserRole.ROLE_CHOICES).get(role, role)} role.')
    return redirect('manage_roles', pk=pk)
...
def config_home(request):
    ...
    return render(request, 'core/config/home.html', {
...
def division_list(request):
    ...
    return render(request, 'core/config/division_list.html', {
        'divisions': divisions,
    })
...
def division_edit(request, pk):
    ...
    if request.method == 'POST':
        ...
        division.display_order = int(request.POST.get('display_order', division.display_order))
        ...
        try:
            ...
            division.league_names = [n.strip() for n in league_names_raw.split(',') if n.strip()]
    ...
    return render(request, 'core/config/division_edit.html', {
        'division': division,
    })
...
def team_list(request):
    ...
    return render(request, 'core/config/team_list.html', {
...
def station_list(request):
    ...
    return render(request, 'core/config/station_list.html', {
        'stations': stations,
    })
...
def station_edit(request, pk):
    ...
    if request.method == 'POST':
        ...
        station.display_order = int(request.POST.get('display_order', station.display_order))
        ...
        try:
            ...
            if isinstance(parsed, list):
                ...
                return render(request, 'core/config/station_edit.html', {'station': station})
        except (json.JSONDecodeError, TypeError):
    ...
    return render(request, 'core/config/station_edit.html', {
        'station': station,
