...
urlpatterns = [
    ...
    path('field/', field_views.field_index, name='field_index'),
    ...
    path('admin/imports/<int:run_id>/review/', import_views.import_review, name='import_review'),
    ...
    path('admin/users/<int:pk>/roles/<int:role_id>/remove/', admin_views.remove_role, name='remove_role'),
    ...
    path('admin/config/divisions/<int:pk>/edit/', admin_views.division_edit, name='division_edit'),
    ...
    path('admin/config/stations/<int:pk>/edit/', admin_views.station_edit, name='station_edit'),
