...
urlpatterns = [
    ...
    path(
        "sessions/<int:pk>/assign/", views.session_assign_players, name="session_assign"
    ),
    # SES Session screen HTMX endpoints
    path(
        "sessions/<int:pk>/roster-search/",
        views.ses_roster_search,
        name="ses_roster_search",
    ),
    path(
        "sessions/<int:pk>/quick-checkin/<int:assignment_id>/",
        views.ses_quick_checkin,
        name="ses_quick_checkin",
    ),
    path(
        "sessions/<int:pk>/quick-reschedule/<int:assignment_id>/",
        views.ses_quick_reschedule,
        name="ses_quick_reschedule",
    ),
    # Check-in
    ...
    path(
        "sessions/<int:pk>/checkin/search/", views.checkin_search, name="checkin_search"
    ),
    path(
        "sessions/<int:pk>/checkin/<int:assignment_id>/",
        views.checkin_player,
        name="checkin_player",
    ),
    ...
    # Reassignment
    path(
        "sessions/<int:pk>/reassign/<int:assignment_id>/",
        views.reassign_player,
    ...
    # QR codes
    path(
        "players/<int:player_season_id>/qr/",
        views.player_qr_code,
        name="player_qr_code",
    ),
